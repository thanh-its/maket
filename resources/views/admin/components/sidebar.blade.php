            ...
            <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    @can('XEM-LOAI-SAN-PHAM')
                        ...
                        <a class="collapse-item" href="{{route('cp-admin.category.index')}}">Danh mục</a>
                    @endcan
                        <h6 class="collapse-header">Biến thể:</h6>
                        <a class="collapse-item" href="{{route('cp-admin.variant.index')}}">Biến thể</a>
                    @can('XEM-SAN-PHAM')
                        <h6 class="collapse-header"> Sản phẩm :</h6>
                        <a class="collapse-item" href="{{route('cp-admin.products.index')}}">Sản phẩm</a>
                    @endcan
                    @can('XEM-NHA-PHAN-PHOI')
                        <h6 class="collapse-header"> Nhà phân phối :</h6>
                        <a class="collapse-item" href="{{route('cp-admin.supplier.index')}}">Nhà phân phối</a>
                    @endcan
                </div>
            </div>
        </li>
